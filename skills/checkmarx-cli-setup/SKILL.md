...
the security plugin can operate. The OS is known from the Gemini CLI session — use the matching
...
running tests). Wait for a hook deny or an explicit setup request.
