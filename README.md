...
| `codex-devassist` | [Codex CLI](https://developers.openai.com/codex/cli) | [plugins/codex-devassist/README.md](plugins/codex-devassist/README.md) |
| Root extension | [Gemini CLI](https://github.com/google-gemini/gemini-cli) | [docs/gemini-cli-devassist.md](docs/gemini-cli-devassist.md) |
